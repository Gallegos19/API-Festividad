import { getFestividades } from "../repositories/festividad.repositories.js";
import { getbyIdFestividades, PostFestividades, putFestividades, DeleteFestividad } from "../repositories/festividad.repositories.js";
...
export const delete_Festividad_Service = async (id) => {
    try {
        const festividad= await DeleteFestividad(id);
        return festividad;
    } catch (error) {
        throw error;
    }
